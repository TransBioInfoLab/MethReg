...
It is important to notice the `log2(exp + 1)` transformation is expected to be performed 
outside the function.

Finally, it will also fit a separate model to samples with  **DNA methylation in low quartile** 
...
results %>% dplyr::select(
    c(1,4,5,grep("DNAmlow|DNAmhigh",colnames(results),invert = TRUE))
    )
...
data("clinical")
metadata <- clinical[,c("sample_type")]
