...
You can install the development version of the package from Bioconductor using the following code:
...
```{R stratified_model, message = FALSE, results = "hide", eval = TRUE}
...
# 6. Controlling effects from confounding variables
