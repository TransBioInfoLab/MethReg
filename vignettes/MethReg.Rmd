...
htmltools::includeHTML("github.html")
```
...
`make_se_from_dnam_probes`. This function will use the Sesame package 
...
```{R}
gene.exp.chr21.se <- make_se_from_gene_matrix(gene.exp.chr21.log2)
gene.exp.chr21.se
