...
```{R plot_interaction_model, eval = TRUE, message = FALSE, results = "hide", warning = FALSE, fig.width = 12}
...
```{R, fig.height = 8, fig.width = 10, eval = TRUE, fig.cap = "An example output from MethReg."}
plots
```
