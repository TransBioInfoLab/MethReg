...
2. Mapping the region to a specific number of genes upstream down/upstream of the region (`method = "nearest.genes"`) [@silva2019elmer].
...
For the analysis of probes in promoter regions, we recommend setting `method = "closest.gene"`.
For the analysis of probes in distal regions, we recommend setting either `method = "window"` or `method = "nearest.genes"`. 
